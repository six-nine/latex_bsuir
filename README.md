# ВНИМАНИЕ
Этот репозиторий больше не поддерживается, более актуальная преамбула лежит на [официальном GitHub факультета](https://github.com/fcsan-bsuir/bsuir-tex-template).
