...
\captionsetup[figure]{labelformat=stbfigure,justification=centering,skip=16pt}
\captionsetup[table]{labelformat=stbtable,justification=raggedright,skip=16pt}
